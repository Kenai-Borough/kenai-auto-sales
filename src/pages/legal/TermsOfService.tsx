    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <nav className="mt-8 rounded-2xl border border-white/10 bg-white/5 p-6">
        ...
        <ol className="mt-3 list-decimal list-inside space-y-1 text-sm text-sky-400">
            ...
            <li><a href="#vehicle-disclaimers" className="hover:text-sky-300 hover:underline">Vehicle Sale Disclaimers</a></li>
      ...
      <div className="mt-10 space-y-10 text-sm leading-relaxed text-slate-300">
        <section id="acceptance">
          ...
          <p className="mt-3">By accessing or using Kenai Auto Sales ("kenaiautosales.com"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the platform. These Terms constitute a legally binding agreement between you and Kenai Peninsula Network / Kenai Borough LLC ("we," "us," or "our").</p>
        ...
        <section id="description">
          ...
          <p className="mt-3">Kenai Auto Sales (kenaiautosales.com) is a local auto, truck, and vehicle marketplace that connects private sellers, buyers, and dealers on the Kenai Peninsula, Alaska. The platform provides vehicle listing tools, search features, dealer portals, and informational resources for local vehicle transactions.</p>
        </section>
        ...
        <section id="third-party">
          ...
          <h2 className="text-2xl font-semibold text-white" id="vehicle-disclaimers">8. Vehicle Sale Disclaimers</h2>
          <p className="mt-3">Kenai Auto Sales does not perform inspections, certifications, or verifications of any kind on listed vehicles. The platform makes no guarantee regarding vehicle condition, mileage accuracy, title status, accident history, or mechanical soundness.</p>
          <p className="mt-3">Buyers should obtain an independent pre-purchase inspection from a qualified mechanic, verify title status with the Alaska Division of Motor Vehicles, and review vehicle history reports before completing any purchase. All transactions are between buyers and sellers directly; the platform is not a party to any vehicle sale.</p>
        ...
        <section id="contact">
          ...
          <ul className="mt-2 space-y-1">
            ...
            <li>Website: <a href="https://kenaiautosales.com" className="text-sky-400 hover:underline">kenaiautosales.com</a></li>
